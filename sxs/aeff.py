...
def get_ddma_v1(brcs_copol, brcs_xpol, A_eff, sp_delay_row, sp_doppler_col):
    ...
    if doppler_frac >= 0:
        ...
        if doppler_intg <= 3:
            brcs_copol_ddma = (
                    (1 - doppler_frac) * (1 - delay_frac) * brcs_copol[doppler_intg, delay_intg] +
            ...
            brcs_xpol_ddma = (
                    (1 - doppler_frac) * (1 - delay_frac) * brcs_xpol[doppler_intg, delay_intg] +
            ...
            A_eff_ddma = (
                    (1 - doppler_frac) * (1 - delay_frac) * A_eff[doppler_intg, delay_intg] +
...
def get_ddma_v2(brcs_copol, brcs_xpol, A_eff, sp_delay_row, sp_doppler_col):
    ...
    if doppler_frac >= 0:
        ...
        brcs_copol_ddma = (
                (1 - delay_frac) * (1 - doppler_frac) * brcs_copol[doppler_range[0], delay_range[0]] +
                (1 - delay_frac) * brcs_copol[doppler_range[1], delay_range[0]] +
                (1 - delay_frac) * brcs_copol[doppler_range[2], delay_range[0]] +
                (1 - delay_frac) * doppler_frac * brcs_copol[doppler_range[3], delay_range[0]] +
                (1 - doppler_frac) * brcs_copol[doppler_range[0], delay_range[1]] +
                brcs_copol[doppler_range[1], delay_range[1]] +
                brcs_copol[doppler_range[2], delay_range[1]] +
                doppler_frac * brcs_copol[doppler_range[3], delay_range[1]] +
                (1 - doppler_frac) * brcs_copol[doppler_range[0], delay_range[2]] +
                brcs_copol[doppler_range[1], delay_range[2]] +
                brcs_copol[doppler_range[2], delay_range[2]] +
                doppler_frac * brcs_copol[doppler_range[3], delay_range[2]] +
                (1 - doppler_frac) * delay_frac * brcs_copol[doppler_range[0], delay_range[3]] +
                delay_frac * brcs_copol[doppler_range[1], delay_range[3]] +
                delay_frac * brcs_copol[doppler_range[2], delay_range[3]] +
                delay_frac * doppler_frac * brcs_copol[doppler_range[3], delay_range[3]]
        )

        brcs_xpol_ddma = (
                (1 - delay_frac) * (1 - doppler_frac) * brcs_xpol[doppler_range[0], delay_range[0]] +
                (1 - delay_frac) * brcs_xpol[doppler_range[1], delay_range[0]] +
                (1 - delay_frac) * brcs_xpol[doppler_range[2], delay_range[0]] +
                (1 - delay_frac) * doppler_frac * brcs_xpol[doppler_range[3], delay_range[0]] +
                (1 - doppler_frac) * brcs_xpol[doppler_range[0], delay_range[1]] +
                brcs_xpol[doppler_range[1], delay_range[1]] +
                brcs_xpol[doppler_range[2], delay_range[1]] +
                doppler_frac * brcs_xpol[doppler_range[3], delay_range[1]] +
                (1 - doppler_frac) * brcs_xpol[doppler_range[0], delay_range[2]] +
                brcs_xpol[doppler_range[1], delay_range[2]] +
                brcs_xpol[doppler_range[2], delay_range[2]] +
                doppler_frac * brcs_xpol[doppler_range[3], delay_range[2]] +
                (1 - doppler_frac) * delay_frac * brcs_xpol[doppler_range[0], delay_range[3]] +
                delay_frac * brcs_xpol[doppler_range[1], delay_range[3]] +
                delay_frac * brcs_xpol[doppler_range[2], delay_range[3]] +
                delay_frac * doppler_frac * brcs_xpol[doppler_range[3], delay_range[3]]
        )

        A_eff_ddma = (
                (1 - delay_frac) * (1 - doppler_frac) * A_eff[doppler_range[0], delay_range[0]] +
                (1 - delay_frac) * A_eff[doppler_range[1], delay_range[0]] +
                (1 - delay_frac) * A_eff[doppler_range[2], delay_range[0]] +
                (1 - delay_frac) * doppler_frac * A_eff[doppler_range[3], delay_range[0]] +
                (1 - doppler_frac) * A_eff[doppler_range[0], delay_range[1]] +
                A_eff[doppler_range[1], delay_range[1]] +
                A_eff[doppler_range[2], delay_range[1]] +
                doppler_frac * A_eff[doppler_range[3], delay_range[1]] +
                (1 - doppler_frac) * A_eff[doppler_range[0], delay_range[2]] +
                A_eff[doppler_range[1], delay_range[2]] +
                A_eff[doppler_range[2], delay_range[2]] +
                doppler_frac * A_eff[doppler_range[3], delay_range[2]] +
                (1 - doppler_frac) * delay_frac * A_eff[doppler_range[0], delay_range[3]] +
                delay_frac * A_eff[doppler_range[1], delay_range[3]] +
                delay_frac * A_eff[doppler_range[2], delay_range[3]] +
                delay_frac * doppler_frac * A_eff[doppler_range[3], delay_range[3]]
        )
        ...
        brcs_copol_ddma = (
                (1 - delay_frac) * abs(doppler_frac) * brcs_copol[doppler_range[0], delay_range[0]] +
                (1 - delay_frac) * brcs_copol[doppler_range[1], delay_range[0]] +
                (1 - delay_frac) * brcs_copol[doppler_range[2], delay_range[0]] +
                (1 - delay_frac) * (1 - abs(doppler_frac)) * brcs_copol[doppler_range[3], delay_range[0]] +
                abs(doppler_frac) * brcs_copol[doppler_range[0], delay_range[1]] +
                brcs_copol[doppler_range[1], delay_range[1]] +
                brcs_copol[doppler_range[2], delay_range[1]] +
                (1 - abs(doppler_frac)) * brcs_copol[doppler_range[3], delay_range[1]] +
                abs(doppler_frac) * brcs_copol[doppler_range[0], delay_range[2]] +
                brcs_copol[doppler_range[1], delay_range[2]] +
                brcs_copol[doppler_range[2], delay_range[2]] +
                (1 - abs(doppler_frac)) * brcs_copol[doppler_range[3], delay_range[2]] +
                abs(doppler_frac) * delay_frac * brcs_copol[doppler_range[0], delay_range[3]] +
                delay_frac * brcs_copol[doppler_range[1], delay_range[3]] +
                delay_frac * brcs_copol[doppler_range[2], delay_range[3]] +
                delay_frac * (1 - abs(doppler_frac)) * brcs_copol[doppler_range[3], delay_range[3]]
        )

        brcs_xpol_ddma = (
                (1 - delay_frac) * abs(doppler_frac) * brcs_xpol[doppler_range[0], delay_range[0]] +
                (1 - delay_frac) * brcs_xpol[doppler_range[1], delay_range[0]] +
                (1 - delay_frac) * brcs_xpol[doppler_range[2], delay_range[0]] +
                (1 - delay_frac) * (1 - abs(doppler_frac)) * brcs_xpol[doppler_range[3], delay_range[0]] +
                abs(doppler_frac) * brcs_copol[doppler_range[0], delay_range[1]] +
                brcs_xpol[doppler_range[1], delay_range[1]] +
                brcs_xpol[doppler_range[2], delay_range[1]] +
                (1 - abs(doppler_frac)) * brcs_xpol[doppler_range[3], delay_range[1]] +
                abs(doppler_frac) * brcs_xpol[doppler_range[0], delay_range[2]] +
                brcs_xpol[doppler_range[1], delay_range[2]] +
                brcs_xpol[doppler_range[2], delay_range[2]] +
                (1 - abs(doppler_frac)) * brcs_xpol[doppler_range[3], delay_range[2]] +
                abs(doppler_frac) * delay_frac * brcs_xpol[doppler_range[0], delay_range[3]] +
                delay_frac * brcs_xpol[doppler_range[1], delay_range[3]] +
                delay_frac * brcs_xpol[doppler_range[2], delay_range[3]] +
                delay_frac * (1 - abs(doppler_frac)) * brcs_xpol[doppler_range[3], delay_range[3]]
        )

        A_eff_ddma = (
                (1 - delay_frac) * abs(doppler_frac) * A_eff[doppler_range[0], delay_range[0]] +
                (1 - delay_frac) * A_eff[doppler_range[1], delay_range[0]] +
                (1 - delay_frac) * A_eff[doppler_range[2], delay_range[0]] +
                (1 - delay_frac) * (1 - abs(doppler_frac)) * A_eff[doppler_range[3], delay_range[0]] +
                abs(doppler_frac) * A_eff[doppler_range[0], delay_range[1]] +
                A_eff[doppler_range[1], delay_range[1]] +
                A_eff[doppler_range[2], delay_range[1]] +
                (1 - abs(doppler_frac)) * A_eff[doppler_range[3], delay_range[1]] +
                abs(doppler_frac) * A_eff[doppler_range[0], delay_range[2]] +
                A_eff[doppler_range[1], delay_range[2]] +
                A_eff[doppler_range[2], delay_range[2]] +
                (1 - abs(doppler_frac)) * A_eff[doppler_range[3], delay_range[2]] +
                abs(doppler_frac) * delay_frac * A_eff[doppler_range[0], delay_range[3]] +
                delay_frac * A_eff[doppler_range[1], delay_range[3]] +
                delay_frac * A_eff[doppler_range[2], delay_range[3]] +
                delay_frac * (1 - abs(doppler_frac)) * A_eff[doppler_range[3], delay_range[3]]
        )
...
def aeff_and_nbrcs(L0, L1, inp, rx_vel_x, rx_vel_y, rx_vel_z, rx_pos_lla):
    ...
    for sec in range(L0.I):
        ...
        for ngrx_channel in range(L0.J_2):
            ...
            if SP_cond and interp_cond and angle_cond:
                ...
                if dop_intg1 <= 3:
                    ...
                    brcs_xpol_ddma1 = (
                        ...
                        + (
                            dop_frac1
                            * del_frac1
                            * brcs_xpol1[del_intg1 + 1, dop_intg1 + 1]
                        )
                    )
                    ...
                    brcs_xpol_ddma1 = (1 - del_frac1) * brcs_xpol1[
                        del_intg1, dop_intg1
                ...
                L1.postCal["nbrcs_scatter_area"][sec][ngrx_channel] = A_eff_ddma1

                L1.nbrcs[sec][ngrx_channel] = nbrcs_copol1
                L1.nbrcs[sec][ngrx_channel + L0.J_2] = nbrcs_xpol1
    ...
    L1.coherency_ratio[:, L0.J_2 : L0.J] = L1.coherency_ratio[:, 0 : L0.J_2]
    L1.coherency_state[:, L0.J_2 : L0.J] = L1.coherency_state[:, 0 : L0.J_2]
