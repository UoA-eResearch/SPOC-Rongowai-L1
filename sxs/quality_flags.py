...
def get_quality_flag(quality_flag1):
    quality_flag = (
        2**21 * quality_flag1[21]
        + 2**20 * quality_flag1[20]
        + 2**19 * quality_flag1[19]
        + 2**18 * quality_flag1[18]
        + 2**17 * quality_flag1[17]
        + 2**16 * quality_flag1[16]
        + 2**15 * quality_flag1[15]
        + 2**14 * quality_flag1[14]
        + 2**13 * quality_flag1[13]
        + 2**12 * quality_flag1[12]
        + 2**11 * quality_flag1[11]
        + 2**10 * quality_flag1[10]
        + 2**9 * quality_flag1[9]
        + 2**8 * quality_flag1[8]
        + 2**7 * quality_flag1[7]
        + 2**6 * quality_flag1[6]
